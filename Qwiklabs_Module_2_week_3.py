...
def main():
  """Processes the list of emails, replacing any instances of the
    ...
    csv_file_location = '/home/student-02-a970479b2e40/data/user_email.csv'
    report_file = '/home/student-02-a970479b2e40/data' +
    ...
    with open(csv_file_location, 'r') as f:
        ...
        for user in user_data_list[1:]:
            for old_domain, new_domain in zip(old_domain_email_list, ner_domain_email_list):
